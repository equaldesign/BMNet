      ...
      <cfsavecontent variable="pagingtabs">
        <cfoutput>
          ...
          <cfif currentPage-1 gt 0>
            <a class="btn btn-mini #arguments.class#" href="#replace(theLink,"@page@",1)#">&laquo;</a>
                  <a class="btn btn-mini #arguments.class#" href="#replace(theLink,"@page@",currentPage-1)#">&larr;</a>
          </cfif>
          ...
          <cfif (currentPage-bandGap) gt 1>
            ...
            <a class="btn btn-mini #arguments.class#" href="#replace(theLink,"@page@",1)#">1</a>
                  <a href="##" class="btn btn-mini btn-disabled">...</a>
          </cfif>
          ...
          <cfloop index="pageIndex" from="#pageFrom#" to="#pageTo#">
              <a class="btn btn-mini #arguments.class# <cfif currentPage eq pageIndex>active</cfif>" href="#replace(theLink,"@page@",pageIndex)#">#pageIndex#</a>
          </cfloop>

          <!--- End Token --->
          <cfif (currentPage+bandgap) lt totalPages>
            <a href="##" class="btn btn-mini  #arguments.class# btn-disabled">...</a>
                  <a class="btn btn-mini #arguments.class#" href="#replace(theLink,"@page@",totalPages)#">#totalPages#</a>
          </cfif>

          <!--- NEXT PAGE --->
          <cfif (currentPage+bandgap) lt totalPages >
            <a class="btn btn-mini #arguments.class#" href="#replace(theLink,"@page@",currentPage+1)#">&rarr;</a>
                  <a class="btn btn-mini #arguments.class#" href="#replace(theLink,"@page@",totalPages)#">&raquo;</a>
          </cfif>

          </div>
          <!---<div class="hidden-phone pagingTabsTotals">Page #currentPage# of  #totalPages#</div>
          <div class="hidden-phone pagingSummary">#arguments.foundRows#  items</div>--->
        </cfoutput>
      </cfsavecontent>
    </cfif>
