...
<cfcomponent name="FormUtilities" hint="Form Utilities" extends="coldbox.system.plugin" output="false">
...
<cffunction name="init" access="public" returntype="any" hint="Constructor.">
  ...
  <cfscript>
    ...
    setpluginName("FormUtilities");
    setpluginVersion("0.1");
    setpluginDescription("Form utilities");
    </cfscript>
  <cfset variables.instance.updateFormScope = true />
  <cfset variables.instance.trimFields = true />
  <cfreturn this />
  </cffunction>
