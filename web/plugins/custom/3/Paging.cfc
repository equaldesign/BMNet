...
<!------------------------------------------- PUBLIC ------------------------------------------->
    ...
    <cfargument name="linkClass" required="true" default="">
    <cfargument name="linkRev" required="true" default="">
		<cfargument name="PagingMaxRows" required="false" type="numeric" hint="You can override the paging max rows here.">
		<!--- ***************************************************************** --->
		...
		<cfif arguments.FoundRows neq 0>
			...
			<div class="pagingTabs">
				...
				<div class="pagingTabsTotals">Page #currentPage# of  #totalPages#</div>

				<div class="pagingTabsCarrousel">

					<!--- PREVIOUS PAGE --->
					<cfif currentPage-1 gt 0>
						<a rev="#arguments.linkRev#" class="previousPage #arguments.linkClass#" href="#replace(theLink,"@page@",currentPage-1)#">&nbsp;</a>
					</cfif>
					...
					<cfif (currentPage-bandGap) gt 1>
						...
						<a rev="#arguments.linkRev#" class="#arguments.linkClass#" href="#replace(theLink,"@page@",1)#">1</a>
						...
					</cfif>
					...
					<cfloop index="pageIndex" from="#pageFrom#" to="#pageTo#">
						<a rev="#arguments.linkRev#" class="#arguments.linkClass# <cfif currentPage eq pageIndex>selected</cfif>" href="#replace(theLink,"@page@",pageIndex)#">#pageIndex#</a>
					</cfloop>

					<!--- End Token --->
					<cfif (currentPage+bandgap) lt totalPages>
						...
						<a rev="#arguments.linkRev#" class="#arguments.linkClass#" href="#replace(theLink,"@page@",totalPages)#">#totalPages#</a>
					</cfif>

					<!--- NEXT PAGE --->
					<cfif (currentPage+bandgap) lt totalPages >
						<a rev="#arguments.linkRev#" class="nextPage #arguments.linkClass#" href="#replace(theLink,"@page@",currentPage+1)#">&nbsp;</a>
					</cfif>
