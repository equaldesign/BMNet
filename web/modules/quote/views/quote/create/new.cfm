 <cfset getMyPlugin(plugin="jQuery").getDepends("UI.autocomplete,validate,form,bindWithDelay,dataTables","products/search,products/table","")>

<cfoutput>
<form id="doQuote" action="/quote/do/finish" class="form form-horizontal" method="post">
<div id="overviewpage" class="row-fluid">
	<div class="span8">
		<div id="stage1">
			<div class="faq-icon">
      ...
      <div class="faq-text">
        ...
        <p>First, we need to know about the products you need. You can search all our product lines using the search below.</p>
        ...
        <div class="control-group">
          ...
          <div class="controls">
            <div class="input-prepend input-append">
              ...
              <button id="doSearch" class="btn btn-success" type="button">Search our products</button>
        ...
        <div class="control-group">
          ...
          <div class="controls">
            <div class="input-prepend">
              ...
              <p class="help-block">Specify a deadline for when you want to hear back from us.</p>
            </div>
          </div>
        </div>
      </fieldset>
	...
	<div class="span4">
        ...
        <input disabled="disabled" type="button" class="finishconfirm pull-right disabled btn btn-info" value="Continue &raquo;" />
	      ...
	      <ol class="faq-list">
	      		...
	      		<div class="faq-icon">
      			  <div class="circle-icon faq-circle-icon">
						...
						<div class="faq-text">
							 ...
							 <p>You enter the products you need, your details and where your want your goods delivered (or where your job is, so we can suggest the closest branch for collection).</p>
            </div>
					</li>
					<li id="faq-2">
            <div class="faq-icon">
            ...
            <div class="faq-text">
            	<h4>We check our stock and confirm fullfilment</h4>
              <p>We'll check we have the products in stock, or tell you when we can get them.</p>
            </div>
          </li>
					<li id="faq-3">
            <div class="faq-icon">
            ...
            <div class="faq-text">
            	<h4>You get your quote in an email</h4>
              <p>You get your quote delivered via email, which you can act upon, add overages, and forward onto your customers if required.</p>
            </div>
          </li>
				</ol>
