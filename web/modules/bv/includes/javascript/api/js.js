	...
	$(document).ready(function(){    
      ...
      $.getScript("https://www.buildingvine.com/includes/javascript/jQuery/jQuery.lightbox.js", function(){
        ...
        css.attr({
          rel: "stylesheet",
          type: "text/css",
          href: "https://www.buildingvine.com/includes/style/jQuery/lightbox/style.css"
        });
      ...
      css.attr({
        rel: "stylesheet",
        type: "text/css",
        href: "https://www.buildingvine.com/includes/style/api/api.css"
      });
        ...
        $.ajax({
          ...
          success: function(data){
            if (data.nodeRef != undefined && data.output.DETAIL != undefined) {
              var bvProductURL = "http://www.buildingvine.com/products/productDetail?nodeRef=" + data.nodeRef;
              
              if (showdocuments == "true") {              
                $.ajax({
                  url: "http://www.buildingvine.com/api/getAssociatedDocuments?nodeRef=" + data.nodeRef,
                  dataType: "jsonp",
                  success: function(data){
                    if (data.hasDocs) {
                      if (usetabs == "true") {
              ...
              if (showSocialIcons == "true") {
                ...
                css.attr({
                  rel: "stylesheet",
                  type: "text/css",
                  href: "https://www.buildingvine.com/includes/style/api/sharrre.css"
                });
