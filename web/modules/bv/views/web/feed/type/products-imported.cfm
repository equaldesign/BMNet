...
<cfoutput>  
 <div class="row feeditem">
   ...
   <div>
     ...
     updated #rc.feedItem.detail.updated# products, and added #rc.feedItem.detail.imported# products into the site  <a href="#bl("sites.#rc.feedItem.siteNetwork#")#">#site.title#</a> <span class="timestamp">#Duration(DateConvertISO8601(rc.feedItem.postDate,0),now())#</span>
