 ...
 <div class="row feeditem">
   <div class="span1">
     ...
     <a href="#bl("profile.index","id=#UrlEncrypt(rc.feedItem.postUserId)#")#">#rc.feedItem.detail.firstName# #rc.feedItem.detail.lastName#</a> 
		 is now following <a href="#bl("sites.#rc.feedItem.siteNetwork#")#">#site.title#</a> <span class="timestamp">#Duration(DateConvertISO8601(rc.feedItem.postDate,0),now())#</span>
