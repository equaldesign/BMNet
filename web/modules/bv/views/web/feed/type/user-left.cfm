...
<cfoutput>  
 <div class="row feeditem">
   ...
   <div>
     ...
     is no longer following <a href="#bl("sites.#rc.feedItem.siteNetwork#")#">#site.title#</a> <span class="timestamp">#Duration(DateConvertISO8601(rc.feedItem.postDate,0),now())#</span>
