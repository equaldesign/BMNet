...
<ul id="relationships">
  <cfoutput>
  <cfloop array="#rc.documentRelationships.associations.mainImage#" index="p">
    <li>
  ...
  <cfloop array="#rc.documentRelationships.associations.imageAssociations#" index="p">
    <li>
      <a class="del" href="/alfresco/service/bv/product/document/associations?nodeRef=#rc.nodeRef#&associationType=ProductImage&assocNode=#p.nodeRef#&alf_ticket=#request.user_ticket#"></a>
        <cfif p.eancode neq "">
          <cfset title ="#p.eancode#">
...
<cfoutput>
<p>Search for other products to relate to this image</p>
<form id="findProducts" action="/alfresco/service/bvine/search/products?siteid=#rc.siteID#&alf_ticket=#request.user_ticket#">
