			...
			<div class="pagingTabs">
				...
				<div class="pagingTabsCarrousel">
					...
					<cfif currentPage-1 gt 0>
						<a class="previousPage ajax" href="#replace(theLink,"@page@",currentPage-1)#">&nbsp;</a>
					</cfif>
					...
					<cfif (currentPage-bandGap) gt 1>
						...
						<a class="ajax" href="#replace(theLink,"@page@",1)#">1</a>
						...
					</cfif>
					...
					<cfloop index="pageIndex" from="#pageFrom#" to="#pageTo#">
						<a class="ajax <cfif currentPage eq pageIndex>selected</cfif>" href="#replace(theLink,"@page@",pageIndex)#">#pageIndex#</a>
					</cfloop>
					
					<!--- End Token --->
					<cfif (currentPage+bandgap) lt totalPages>
						...
						<a class="ajax" href="#replace(theLink,"@page@",totalPages)#">#totalPages#</a>
					</cfif>
					
					<!--- NEXT PAGE --->
					<cfif (currentPage+bandgap) lt totalPages >
						<a class="nextPage ajax" href="#replace(theLink,"@page@",currentPage+1)#">&nbsp;</a>
					</cfif>
