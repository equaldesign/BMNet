...
<div class="widget big-stats-container">
  <div class="widget-content">
    <div id="big_stats" class="cf">
      ...
      <div class="stat">
        <h4>Server 1</h4>
        <a href="##" class="pop" title="Outages today" data-content="#getOutages(rc.server1.summary.status.totaldown)#"><img src="http://help.ebiz.co.uk/modules/bugs/includes/images/#getToday(rc.server1.summary.status.totaldown)#.png" /></a>
        <div><span class="value">#decimalFormat(rc.server1.summary.responsetime.avgresponse/1000)#</span> sec avg</div>
      </div> <!-- .stat -->
      <div class="stat"> 
        <h4>Server 2</h4>
        <a href="##" class="pop" title="Outages today" data-content="#getOutages(rc.server2.summary.status.totaldown)#"><img src="http://help.ebiz.co.uk/modules/bugs/includes/images/#getToday(rc.server2.summary.status.totaldown)#.png" /></a>
        <div><span class="value">#decimalFormat(rc.server2.summary.responsetime.avgresponse/1000)#</span> sec avg</div>
      </div> <!-- .stat -->
      <div class="stat">
        <h4>Server 3</h4>
        <a href="##" class="pop" title="Outages today" data-content="#getOutages(rc.server3.summary.status.totaldown)#"><img src="http://help.ebiz.co.uk/modules/bugs/includes/images/#getToday(rc.server3.summary.status.totaldown)#.png" /></a>
        <div><span class="value">#decimalFormat(rc.server3.summary.responsetime.avgresponse/1000)#</span> sec avg</div>
      </div> <!-- .stat -->
      <div class="stat">
        <h4>Load Balancer</h4>
        <a href="##" class="pop" title="Outages today" data-content="#getOutages(rc.loadBalancer.summary.status.totaldown)#"><img src="http://help.ebiz.co.uk/modules/bugs/includes/images/#getToday(rc.loadBalancer.summary.status.totaldown)#.png" /></a>
