<cfoutput><h2><a href="/mxtra/account/invoiceDetail?id=#rc.invoiceID#&output=pdf" target="_blank">Print this invoice</a></h2></cfoutput>

<div id="invoice">
	<div class="invoice_logo">
	  <cfoutput><img src="/includes/images/sites/#request.siteID#/logo.png"></cfoutput>
    <cfoutput>
    <div class="invoice_logo_text">
	    <h3>Turnbull &amp; Co Ltd</h3>
			<p>95 Southgate<br />
			Sleaford<br />
			Lincs.<br />
			NG34 7RQ
	  ...
	  <table width="100%">
	    ...
	    <tbody>
	      ...
	      <tr>
	        ...
	        <td class="c">#trim(numberFormat(lineTotal/lineQuantity,"9999.00"))# #UNIT_OF_SALE#</td>
	        <td class="c"></td>
	        <td class="c">#lineTotal#</td>
	        <td class="c">S</td>
	      </tr>
	      </cfoutput>
	    </tbody>
    ...
    <div class="invoice_summary">
      ...
      <table>
        ...
        <tr>
          ...
          <td class="tlight"><div>#rc.invoice.line_total#</div></td>
          <td class="tlight"><div><cfif rc.invoice.line_total lt 0>-</cfif> #Trim(NumberFormat(rc.invoice.vat_total,"9999.00"))#</div></td>
        </tr>
        </cfoutput>
      </table>
    </div>
    <div class="invoice_total">
      ...
      <table>
        ...
        <tr>
          ...
          <cftry><td class="tlight"><div>&pound;#rc.invoice.line_total#</div></td><cfcatch></cfcatch></cftry>
        </tr>
        <tr>
          <td class="tdark"><div>Total VAT</div></td>
          <cftry><td class="tlight"><div>&pound; <cfif rc.invoice.line_total lt 0>-</cfif> #Trim(NumberFormat(rc.invoice.vat_total,"9999.00"))#</div></td><cfcatch></cfcatch></cftry>
        </tr>
        <tr>
          <td class="tdark"><div>TOTAL</div></td>
          <cftry><td class="tlight"><div>
            &pound;<cfif rc.invoice.line_total lt 0>#DecimlaFormat(rc.invoice.line_total-rc.invoice.vat_total)#<cfelse>#DecimalFormat(rc.invoice.line_total+rc.invoice.vat_total)#</cfif>
