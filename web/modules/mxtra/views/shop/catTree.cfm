...
<div>
  <form id="shopSearch" class="form form-inline" action="/mxtra/shop/product/search" method="post">
  ...
  <ul id="mainLinks" class="nav nav-list">
    ...
    <cfif rc.leftCategories.recordCount neq 0>
      <cfoutput query="rc.leftCategories">
        <li class="#IIf(rc.categoryID eq id,'"active"','""')#"><a href="#bsl('/mxtra/shop/category/#pageSlug#?categoryID=#id#')#"><i class="icon-chevron-right"></i> #capFirstTitle(name)#</a></li>
      </cfoutput>
