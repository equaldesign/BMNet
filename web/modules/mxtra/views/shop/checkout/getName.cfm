...
<div class="alert alert-info">
  ...
  <form id="checkout" class="form-horizontal" action="/mxtra/shop/checkout" method="post">
    ...
    <div class="control-group #isErrorField('bA')#">
      ...
      <div class="controls">
        <textarea class="nice #isErrorField('dA')#" cols="20" rows="5" name="bA">#rc.order.delivery.address#</textarea>
      </div>
    </div>
    <div class="control-group #isErrorField('bPC')#">
      <label class="control-label" for="bPC">Postcode<em>*</em></label>
      <div class="controls">
        <input type="text" name="bPC" size="10" class="nice #isErrorField('bPC')#" value="#rc.order.delivery.postCode#">
      </div>
    </div>
    </div>
