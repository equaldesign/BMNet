<cfcomponent output="false"  cache="true">
  <cfproperty name="category" inject="model:shop.category" scope="instance" />
  <cfproperty name="product" inject="model:shop.products" scope="instance" />
...
<cffunction name="jsonsearch" returntype="void" output="false">
  ...
  <cfloop endrow="10" query="results">
