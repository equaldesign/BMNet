...
<div id="homepagecontrols" class="glow">
  <ul>
    <li class="first"><a  class="feed" href="/feed">Feed</a></li>
    <cfif isUserInAnyRole("figures,EnterFigures")><li><a  class="dashboard" href="/dashboard">Dashboard</a></li></cfif>
    <li><a rev="homepage" class="buildingVine" href="/bv/feed">BuildingVine</a></li>
    <li><a rev="homepage" class="blog" href="/bv/blog?siteID=#rc.sess.buildingVine.siteID#">Company News</a></li>
