 ...
 <cfset emailCampaign = cs.getCampaign(args.data.relatedID[currentRow])>
  <div class="media">
    ...
    <div class="media-body">
       <h4 class="media-heading"><i class="icon-mail-open"></i><a href="/marketing/email/campaign/detail/id/#emailCampaign.id#">#emailCampaign.name#</a></h4>
         <a href="#bl('contact.index','id=#user.id#')#">#user.first_name# #user.surname#</a>
         read the campaign email
