  ...
  <div class="media">
    ...
    <div class="media-body">
       <h4 class="media-heading"><i class="icon-clipboard-task"></i><a href="/flo/item/detail/id/#floItem.task.id#">#floItem.task.name#</a></h4>
         <a href="#bl('contact.index','id=#user.id#')#">#user.first_name# #user.surname#</a> created a new workflow item
         with #floItem.activities.recordCount# activit<cfif floItem.activities.recordCount neq 1>ies<cfelse>y</cfif> and the following actor<cfif floItem.dependencies.recordCount neq 1>s</cfif>:
