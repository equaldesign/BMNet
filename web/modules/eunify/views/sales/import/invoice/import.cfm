<cfset getMyPlugin(plugin="jQuery").getDepends("","sales/import/import","")>
<div class="row-fluid">
  <div class="span4">
  ...
  <div id="ajaxMain" class="span8">
    <form id="ssUpload" class="form form-horizontal" action="/eunify/products/doImport" method="post">
      <fieldset>
        <legend>Import Sales Ledger</legend>
        <div class="control-group">
          ...
          <div class="controls">
            ...
            <p class="help-block">Browser your computer to find your ledger file</p>
