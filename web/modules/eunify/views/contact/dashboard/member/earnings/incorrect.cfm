<cfset getMyPlugin(plugin="jQuery").getDepends("dataTables","psa/payments,psa/payments/incorrect","tables")>
<div class="small tclothtable">
  <cfoutput><h2>Part-Payments Received in #DateFormat(now(),"YYYY")#</h2></cfoutput>
  <div style="padding: 0pt 0.7em; margin: 5px 0px;" class="Aristo ui-state-highlight ui-corner-all">
    ...
    <p>This table shows rebate you have toggled as part-paid or incorrect.</p>
    <p>This will help you keep track of your rebate payments.</p>
  </div>
  <table class="dataTable" id="incorrect">
    <thead>
      <tr>
        <th>Supplier</th>
        <th>Amount</th>
