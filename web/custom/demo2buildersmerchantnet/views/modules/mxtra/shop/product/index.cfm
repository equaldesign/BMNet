...
<cfset getMyPlugin(plugin="jQuery").getDepends("form","basket","")>
  ...
  <cfoutput>#getModel("ProductService").breadcrumb(categoryID=rc.categoryID,urlString="&brands=#rc.brands#&priceFrom=#rc.priceFrom#&priceTo=#rc.priceTo#&itemsPerPage=#rc.itemsPerPage#&viewMode=#rc.viewMode#")#</cfoutput>
  </cfif>
      ...
      <ul class="thumbnails">
        <cfloop query="rc.categories">
          <li class="thumbnail span2">
            <a href="/mxtra/shop/category/#pageslug#?viewMode=#rc.viewMode#&itemsPerPage=#rc.itemsPerPage#&brands=#rc.brands#&priceFrom=#rc.priceFrom#&priceTo=#rc.priceTo#&categoryID=#id#">
              <cfif BVNodeRef neq "">
