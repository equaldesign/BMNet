  ...
  <body>
    ...
    <div id="sidebar">
      ...
      <ul>
          ...
          <ul>
            <li class="submenu"><a href="##"><i class="icon-balloon-facebook"></i>Social</a>
              <ul>
                ...
                <li><a href="/marketing/twitter"><i class="icon-balloon-twitter"></i>Twitter</a></li>
              </ul>
            </li>
        ...
        <li class="#IIf(event.getCurrentModule() eq 'bv' AND event.getCurrentHandler() neq 'documents',"'active'","''")#">
          <a rel="maincontent" href="/bv/site/list"><i class="icon-buildingVine"></i><span>Building Vine&trade;</span></a>
        </li>
        <li class="#Iif(event.getCurrentModule() eq 'bv' AND event.getCurrentHandler() eq 'documents','"active"','""')#"><a rel="maincontent" class="documents" href="/bv/documents/getFolder?siteID=#
        rc.sess.buildingVine.siteID#"><i class="icon-documents"></i><span>Documents</span></a></li>
