...
<cfset rc.baseCats = rc.category.categoryList(rc.categoryID,rc.priceFrom,rc.priceTo,rc.brands,true)>
...
<div class="well">
	<form class="form-search" action="/mxtra/shop/product/search">
	  <div class="input-append">
	    <input name="q" class="input-small" placeholder="Search..." />
	    <input type="submit" class="btn btn-success" value="Search">
	  </div>
	</form>

	<ul class="nav nav-list">
		<cfif rc.categoryID neq 0><cfoutput><li class="active"><a href="/mxtra/shop/category/index?viewMode=#rc.viewMode#&itemsPerPage=#rc.itemsPerPage#&brands=#rc.brands#&priceFrom=#rc.priceFrom#&priceTo=#rc.priceTo#&categoryID=#rc.thisCategory.parentid#"><i class="icon-up"></i> Up a level</a></li></cfoutput></cfif>
		<cfif rc.baseCats.recordCount neq 0>
