...
<cfoutput>
  <div id="basketO"  class="basket">
    <h3><a href="/mxtra/shop/basket">Basket <i class="icon-basket h3"></i></a></h3>
    #basketLines# Item<cfif basketLines neq 1>s</cfif>&nbsp;<cfif basketTotal neq 0>|&nbsp;&pound;#DecimalFormat(VATPrice(basketTotal))#&nbsp
	  
	  <div>
	  <br />
			<a href="/mxtra/shop/checkout" class="btn btn-success">Confirm &raquo;</a>
	  </div>
	  </cfif>
	  <br />		
  </div>  
