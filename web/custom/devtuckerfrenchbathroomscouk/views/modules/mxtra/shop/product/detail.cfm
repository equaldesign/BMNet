...
<cfoutput>#getModel("eunify.ProductService").breadcrumb(categoryID=rc.categoryID,productID=rc.productID,urlString="&brands=#rc.brands#&priceFrom=#rc.priceFrom#&priceTo=#rc.priceTo#&itemsPerPage=#rc.itemsPerPage#&viewMode=#rc.viewMode#")#</cfoutput>
  <div class="row">
      ...
      <ul class="nav nav-tabs">
        ...
        <cfif StructKeyExists(rc.metaData,"tabData")>
          <cfloop array="#rc.metaData.tabData#" index="t">
            <li class="active"><a data-toggle="tab" href="##mt_#friendlyUrl(t.customProperties.metaTitle)#">#t.customProperties.metaTitle#</a></li>
          </cfloop>
        </cfif>
      </ul>
