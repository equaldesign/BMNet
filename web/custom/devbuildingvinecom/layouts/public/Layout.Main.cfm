...
<cfoutput>
  #getMyPlugin(plugin="jQuery").getDepends("bootstrap,bbq,address,form,block,cycle,easing.1.3,cookie,tp,sr,tipsy,livequery,scroll","","tipsy,bootstrap,bootstrap-responsive.min,jQuery/sr/settings,sites/14/styles",false)#
</cfoutput>   
...
<cfoutput>#renderView("header")#</cfoutput>
<cfoutput>#renderView("layoutPre")#</cfoutput>
<cfoutput>#renderView("footer")#</cfoutput>
