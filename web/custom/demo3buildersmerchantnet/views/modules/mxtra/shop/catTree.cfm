...
<div>
  <form id="shopSearch" class="form form-inline" action="/mxtra/shop/product/search">
    <div class="input-append">
      <input type="text" name="q" class="span2" placeholder="Search for a product..." />
  ...
  <ul id="mainLinks" class="nav nav-list">
    <cfif rc.productID neq 0>
      <cfoutput><li><a href="/mxtra/shop/category/index?viewMode=#request.mxtra.filter.viewMode#&itemsPerPage=#request.mxtra.filter.itemsPerPage#&brands=#request.mxtra.filter.brands#&priceFrom=#request.mxtra.filter.priceFrom#&priceTo=#request.mxtra.filter.priceTo#&categoryID=#rc.categoryID#"><i class="icon-arrow-merge-090"></i> Up a level</a></li></cfoutput>
    <cfelseif rc.categoryID neq 0>
      <cfoutput><li><a href="/mxtra/shop/category/index?viewMode=#request.mxtra.filter.viewMode#&itemsPerPage=#request.mxtra.filter.itemsPerPage#&brands=#rc.brands#&priceFrom=#request.mxtra.filter.priceFrom#&priceTo=#request.mxtra.filter.priceTo#&categoryID=#rc.thisCategory.parentid#"><i class="icon-arrow-merge-090"></i> Up a level</a></li></cfoutput>
    </cfif>
    <cfif rc.leftCategories.recordCount neq 0>
      <cfoutput query="rc.leftCategories">
        <li class="#IIf(rc.categoryID eq id,'"active"','""')#"><a href="/mxtra/shop/category/#pageSlug#?viewMode=#request.mxtra.filter.viewMode#&itemsPerPage=#request.mxtra.filter.itemsPerPage#&brands=#request.mxtra.filter.brands#&priceFrom=#request.mxtra.filter.priceFrom#&priceTo=#request.mxtra.filter.priceTo#&categoryID=#id#"><i class="icon-chevron-right"></i> #capFirstTitle(name)#</a></li>
      </cfoutput>
