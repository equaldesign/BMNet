...
<cfset getMyPlugin(plugin="jQuery").getDepends("dataTables","main,homeaccordion,accordion,filter","sites/3/main,sites/3/nav,tabs,shortcuts,divtables,tables",true,"eunify")>
