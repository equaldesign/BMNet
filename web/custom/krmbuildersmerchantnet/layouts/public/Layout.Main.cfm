...
<body class="body">
  ...
  <div class="wrapper" id="main">
    <div class="navbar navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container rel">
          ...
          <a class="brand" href="#"><img class="img-rounded" src="/includes/images/sites/12/logo.gif" border="0"></a>
	...
	<cfset branches = getModel("templates.branchlocator").getBranches(26,"eGroup_nbg")>
  <footer>
    <div class="hidden-phone container">
        ...
        &nbsp;<a href="/html/privacy.html">Privacy</a>.</p>
		  <p style="text-align:center">Copyright &copy; <cfoutput>#year(now())# KRM Building Supplies Ltd &amp; Co Ltd.</cfoutput></p>
