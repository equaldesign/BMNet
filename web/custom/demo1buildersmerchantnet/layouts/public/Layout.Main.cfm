...
<cfoutput>
  #getMyPlugin(plugin="jQuery").getDepends("bootstrap,bbq,address,form,block,cycle,easing.1.3,cookie,tp,sr,spin,loadNicely","images","bootstrap,bootstrap-responsive.min,jQuery/sr/settings",false)#
</cfoutput>
...
<footer id="footer">
    ...
    <div class="row">
        <div class="span3">
            <h3>About this</h3>
            <p>This website is a demonstration website, to show the functionality of <a href="http://www.buildersmerchant.net">BuildersMerchant.net</a></p>
        </div>
        <div class="span3">
            <h3>Flickr Photos</h3>
