...
<cfoutput>#getMyPlugin(plugin="jQuery").getDepends("","sites/1/homepage","sites/1/homepage,jQuery/sr/default",false)#</cfoutput>
<div id="mainpLinks">
       ...
       <div class="fullwidthbanner">
         <ul>
          ...
          <cfoutput query="features">
             <li data-transition="boxslide" data-slotamount="7" data-link="/mxtra/shop/product/#pageslug#?productID=#product_code#">
               ...
               <div class="caption sft big_white"  data-x="320" data-y="80" data-speed="700" data-start="1700" data-easing="easeOutBack">#showProd(Full_Description,Web_Name)#</div>
               <cfset rc.price = showBestPrice(Retail_Price,Trade,web_price,web_trade_price,subunit,subsperunit)>
               <div class="caption sfb big_orange"  data-x="320" data-y="142" data-speed="500" data-start="1900" data-easing="easeOutBack">Only &pound;#trim(VATPrice(rc.price))# <small>#doUnit(unitDisplay,subunit)#</small></div>
               <div class="caption lfl" data-x="320" data-y="215" data-speed="500" data-start="2100" data-easing="easeOutBack"><a href="/mxtra/shop/product/#pageslug#?productID=#product_code#" class="btn btn-success"><strong>more info</strong></a></div>
               ...
               <div class="intro">#web_description#</div>
             </li>
           </cfoutput>
         </ul>
       </div>
