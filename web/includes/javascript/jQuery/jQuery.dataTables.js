  ...
  var DataTable = function( oInit )
  {
    ...
    function _fnFeatureHtmlFilter ( oSettings )
    {
      ...
      sSearchStr = (sSearchStr.indexOf('_INPUT_') !== -1) ?
        sSearchStr.replace('_INPUT_', '<div class="input-prepend"><span class="add-on"><img src="https://d25ke41d0c64z1.cloudfront.net/images/icons/magnifier.png" /></span><input class="input-large" type="text" /></div>') :
        sSearchStr==="" ? '<div class="input-prepend"><span class="add-on"><img src="https://d25ke41d0c64z1.cloudfront.net/images/icons/magnifier.png" /></span><input type="text" class="input-large" /></div>' : ' <div class="input-prepend"><span class="add-on"><img src="https://d25ke41d0c64z1.cloudfront.net/images/icons/magnifier.png" /></span><input class="input-large" type="text" /></div>';
      
      var nFilter = document.createElement( 'form' );
    ...
    function _fnFeatureHtmlLength ( oSettings )
    {
      ...
      var sName = 'class="span1" name="'+oSettings.sTableId+'_length"';
      ...
      var nLength = document.createElement( 'form' );
  ...
  $.extend( $.fn.dataTableExt.oPagination, {
    "bootstrap": {
      "fnInit": function( oSettings, nPaging, fnDraw ) {
        ...
        $(nPaging).append(
          '<div class="btn-group">'+
            '<a class="btn btn-mini disabled" href="#">&larr; '+oLang.sPrevious+'</a>'+
            '<a class="btn btn-mini disabled" href="#">'+oLang.sNext+' &rarr; </a>'+
          '</div>'
        );
        var els = $('a', nPaging);
      ...
      "fnUpdate": function ( oSettings, fnDraw ) {
        ...
        for ( i=0, iLen=an.length ; i<iLen ; i++ ) {
          ...
          $('a:gt(0)', an[i]).filter(':not(:last)').remove();
  
          // Add the new list items and their event handlers
          for ( j=iStart ; j<=iEnd ; j++ ) {
            sClass = (j==oPaging.iPage+1) ? 'class="btn btn-mini active"' : 'class="btn btn-mini"';
            $('<a '+sClass+' href="#">'+j+'</a>')
              .insertBefore( $('a:last', an[i])[0] )
          ...
          if ( oPaging.iPage === 0 ) {
            $('a:first', an[i]).addClass('disabled');
          } else {
            $('a:first', an[i]).removeClass('disabled');
          }
