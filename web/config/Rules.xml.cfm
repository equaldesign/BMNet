...
<rules>
    <rule>
        <whitelist>bv.profile.reset,eunify.api.*,eunify.login.*,eunify.email.fastFile,eunify.company.doEdit,signup.*,eunify.calendar.register,unify.calendar.doRegister,eunify.comment.add</whitelist>
        <securelist>eunify.*,eGroup.*,mxtra.account.*,flo.*,bv.profile.*</securelist>
